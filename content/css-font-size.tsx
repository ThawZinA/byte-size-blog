export const post = {
  slug: "css-font-size",
  title: "CSS Font Size: A Complete Guide",
  abstract:
    "Learn everything you need to know about CSS font-size property, from basic usage to advanced techniques for responsive typography.",
